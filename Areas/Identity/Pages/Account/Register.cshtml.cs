...
namespace SmartJobRecommender.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Immediately signs the user into the application
                    await _signInManager.SignInAsync(user, isPersistent: false);
                    return LocalRedirect(returnUrl);
                }
                // Handle creation errors (e.g., password doesn't meet requirements, email already exists)
        ...
        // Helper method to create a new IdentityUser
        ...
        // Helper method to retrieve the email store
